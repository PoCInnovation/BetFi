...
contract ProposeStrategyScript is Script {
    ...
    address immutable FACTORY = vm.envAddress("STARTEGY_FACTORY");
    ...
    uint256 constant OBJECTIVE_PERCENT = 100; // 1% (in basis points)
    ...
    function run() external {
        ...
        StrategyFactory(FACTORY).proposeStrategy(
            VAULTS,
            AMOUNTS,
            TRADER_TOKEN,
            OBJECTIVE_PERCENT,
