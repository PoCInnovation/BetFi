import { EnqueueObject, EventObject, EventPayloadMap, ExtractEvents, Store, StoreAssigner, StoreContext, StoreConfig, StoreSnapshot, StoreLogic, StoreTransition } from "./types.js";
...
export declare function createStore<TContext extends StoreContext, TEvent extends EventObject, TEmittedPayloadMap extends EventPayloadMap>(logic: StoreLogic<StoreSnapshot<TContext>, TEvent, ExtractEvents<TEmittedPayloadMap>>): Store<TContext, TEvent, ExtractEvents<TEmittedPayloadMap>>;
