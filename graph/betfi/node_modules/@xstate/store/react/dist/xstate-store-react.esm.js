...
import { a as createStore } from '../../dist/store-f80a6837.esm.js';
...
function useSelector(store, selector, compare = defaultCompare) {
  ...
  return useSyncExternalStore(useCallback(handleStoreChange => store.subscribe(handleStoreChange).unsubscribe, [store]), () => selectorWithCompare(store.get()), () => selectorWithCompare(store.get()));
}
...
export { useAtom, useSelector, useStore };
