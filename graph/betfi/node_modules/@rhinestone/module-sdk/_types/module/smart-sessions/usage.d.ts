...
export declare const getEnableSessionDetails: ({ sessions, sessionIndex, enableMode, account, clients, enableValidatorAddress, permitGenericPolicy, permitAdminAccess, ignoreSecurityAttestations, sessionNonces, }: {
    sessions: Session[];
    sessionIndex?: number;
