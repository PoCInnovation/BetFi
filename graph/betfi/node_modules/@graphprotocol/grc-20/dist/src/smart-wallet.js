 ...
 */
export const getSmartAccountWalletClient = async ({ privateKey, rpcUrl = MAINNET_DEFAULT_RPC_URL, }) => {
...
export const getWalletClient = async ({ privateKey, rpcUrl = TESTNET_DEFAULT_RPC_URL, }) => {
