...
export type Op = UpdateEntityOp | CreateRelationOp | DeleteRelationOp | UpdateRelationOp | CreatePropertyOp | UnsetEntityValuesOp | UnsetRelationFieldsOp;
export type ValueOptionsParams = {
    type: 'number';
    unit?: string | Id | undefined;
} | {
    type: 'text';
    language?: string | Id | undefined;
};
...
export type PropertiesParam = Array<{
    property: Id | string;
} & ValueParams>;
